...
def send_approval_email(username: str, to_email: str) -> bool:
    subject = "Your Xchange Book Account Has Been Approved"
    html = f"""
    <div style="font-family:'Plus Jakarta Sans',Arial,sans-serif;max-width:560px;margin:0 auto;background:#0a0e17;color:#f0f4f8;padding:40px;border-radius:16px;">
      <div style="text-align:center;margin-bottom:32px;">
        <h1 style="background:linear-gradient(135deg,#00d4aa,#6366f1);-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-size:28px;margin:0;">Xchange Book</h1>
      ...
      <div style="background:#1a2035;border-radius:12px;padding:28px;border:1px solid #1e2a45;">
        ...
        <p style="color:#8899a6;line-height:1.7;">Your account request for <strong style="color:#f0f4f8;">Xchange Book</strong> has been reviewed and approved by our admin team.</p>
        ...
        <div style="text-align:center;margin:28px 0;">
          <a href="{settings.SITE_URL}" style="background:linear-gradient(135deg,#00d4aa,#6366f1);color:white;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;display:inline-block;">Login to Xchange Book</a>
        </div>
...
def send_rejection_email(username: str, to_email: str) -> bool:
    subject = "Your Xchange Book Account Request Status"
    html = f"""
    <div style="font-family:'Plus Jakarta Sans',Arial,sans-serif;max-width:560px;margin:0 auto;background:#0a0e17;color:#f0f4f8;padding:40px;border-radius:16px;">
      <div style="text-align:center;margin-bottom:32px;">
        <h1 style="background:linear-gradient(135deg,#00d4aa,#6366f1);-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-size:28px;margin:0;">Xchange Book</h1>
      ...
      <div style="background:#1a2035;border-radius:12px;padding:28px;border:1px solid #1e2a45;">
        ...
        <p style="color:#8899a6;line-height:1.7;">Hi <strong style="color:#f0f4f8;">{username}</strong>,</p>
        <p style="color:#8899a6;line-height:1.7;">After review, your access request for Xchange Book has not been approved at this time.</p>
...
def send_signup_notification_to_admin(username: str, admin_email: str) -> bool:
    ...
    <div style="font-family:'Plus Jakarta Sans',Arial,sans-serif;max-width:560px;margin:0 auto;background:#0a0e17;color:#f0f4f8;padding:40px;border-radius:16px;">
      <div style="background:#1a2035;border-radius:12px;padding:28px;border:1px solid #1e2a45;">
        ...
        <p style="color:#8899a6;line-height:1.7;">A new user has requested access to Xchange Book:</p>
...
def send_role_update_email(username: str, to_email: str, new_role: str) -> bool:
    subject = "Your Xchange Book Account Role Has Been Updated"
    html = f"""
    <div style="font-family:'Plus Jakarta Sans',Arial,sans-serif;max-width:560px;margin:0 auto;background:#0a0e17;color:#f0f4f8;padding:40px;border-radius:16px;">
      <div style="text-align:center;margin-bottom:32px;">
        <h1 style="background:linear-gradient(135deg,#00d4aa,#6366f1);-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-size:28px;margin:0;">Xchange Book</h1>
